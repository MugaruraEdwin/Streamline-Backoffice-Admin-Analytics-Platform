...
function ResetPassword() {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('https://streamline-admin-analytics-platform.azurewebsites.net:3000/forgot-password', { email })
            .then(response => {
                if (response.data.success) {
                    // If email exists, proceed to reset password
                    axios.post('https://streamline-admin-analytics-platform.azurewebsites.net:3000/reset-password', { email, newPassword, newConfirmPassword})
                        .then(response => {
                            if (response.data.success) {
